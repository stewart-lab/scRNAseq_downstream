...
```{r plot_if_annotated}
# Curated columns worth visualizing. Deliberately excludes:
#  - Cassia_clus1_score: a numeric confidence score, not a cell-type label.
...
plot_cols <- intersect(
  c("Cassia_clus1_general_celltype", "Cassia_clus1_sub_celltype", "Cassia_clus1_combined_celltype"),
...
if (length(plot_cols) >= 1) {
  ...
  pdf(
    file = file.path(OUTPUT_DIR, "Cassia_annot_clus1_umap.pdf"),
