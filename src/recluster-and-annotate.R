...
write.table(seurat.obj_recluster.metadata,
    file = paste0(output, "manual_annot_metadata_", resolution, ".txt"), sep = "\t",
    quote = F, row.names = T
)
