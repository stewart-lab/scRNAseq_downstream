...
metadata.gamm <- read.csv("/w5home/bmoore/Gamm_scRNAseq/data/gamm_metadata/gamm_manual_annot_metadata_c0.5.txt", row.names = 1, 
            header = TRUE, sep = "\t")
