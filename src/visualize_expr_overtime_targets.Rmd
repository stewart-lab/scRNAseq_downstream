...
output <- paste0(DATA_DIR, "output_bulk_expr_", timestamp)
print(output)
...
# plot function
```{r}
plot_function <- function(df_summary_connected, gene, Celltype, timept, output) {
    ...
    pdf(
        file = paste0(
            output, gene, "_", Celltype, "_", timept, "_expr_lineplot",
            ".pdf"
        ),
        height = 4, width = 5
    )
