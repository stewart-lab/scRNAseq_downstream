...
ORTHOLOGS <- "/w5home/bmoore/Gamm_scRNAseq/data/human_orthologs/Human_Pig_Biomart_Filtered_mod.txt"
...
# read in orthologs
```{r orthologs}
# Reminder: these are in the data folder of the github repo...
orthologs <- read.csv2(ORTHOLOGS, sep="\t", header=TRUE)
```
# subset matrices
```{r subset}
...
```
# check metadata and add to object
```{r}
metadata1[1:5,]
metadata2[1:5,]
