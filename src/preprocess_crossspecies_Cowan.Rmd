...
exp.matrix1 <- read_aligned_data(
    paste0(WD,"output_F49i-N-B7/Solo.out/GeneFull/"),
    "F49i-N-B7",output
    )
exp.matrix2 <- read_aligned_data(
    paste0(WD,"output_IMR90-4-DL-01/Solo.out/GeneFull/"),
    "IMR90-4-DL-01",output
    )

# load gamm pig data sample 2
gamm.data <- read_aligned_data(
    "/w5home/bmoore/scRNAseq/GAMM/output_S2_mm_mt/Solo.out/GeneFull/",
    "gamm.data.S2",output
    )
```
