...
setwd(paste0(BETHS_GAMM_DATA_DIR, "GAMM_S1/output_20230921_142919/"))
output <- paste0(BETHS_GAMM_DATA_DIR, "GAMM_S1/output_20230921_142919/")
# copy config and source functions
file.copy(paste0(GIT_DIR,"config.json"), file.path(paste0(output, "config2.json")))
...
write.table(gamm.metadata, file = "gammS1_manual_annot_metadata_c0.5_KR.txt", sep="\t", 
            quote=F, row.names = T)
```
