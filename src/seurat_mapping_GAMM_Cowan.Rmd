...
metadata <- read.csv2("/w5home/bmoore/Gamm_scRNAseq/data/cowan_metadata/meta_30weeks_mod.txt", sep="\t", header=TRUE, row.names=1)
# subset by D205 data
...
metadata.gamm <- read.csv("/w5home/bmoore/Gamm_scRNAseq/data/gamm_metadata/gamm_manual_annot_metadata_c0.5.txt", 
