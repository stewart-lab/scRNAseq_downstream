...
```
```{r load_data}
data_dir <- "/w5home/bmoore/Pierre_sc_zebrafish/cellchat/mouse_objects/"
setwd(data_dir)
filename <- "seurat_mouse_annot_4wkR.rds"
name <- basename(filename)
timestamp <- format(Sys.time(), "%Y%m%d_%H%M%S")
output <- paste0(data_dir, name,"_cellchat_AG_genes_",timestamp)
print(output)
