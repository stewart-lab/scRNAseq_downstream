...
ptm = Sys.time()
groupSize <- as.numeric(table(cellchat@idents))
pdf(file="cc_interactions_celltype_circleplot.pdf")
...
pdf(file="cc_interactions_celltype_circleplot2.pdf")
...
for (i in 1:length(pathways.show.all)) {
                ...
                netVisual(cellchat, signaling = pathways.show.all[i], vertex.receiver = vertex.receiver, layout = "hierarchy",out.format ="pdf")
                #dev.off()
...
library(reticulate)
# read back in
output <- "/w5home/bmoore/Pierre_sc_zebrafish/seurat_mouse_annot_4wkNR_cellchat_20250425_164709/"
cellchat <- readRDS(paste0(output,"seurat_mouse_annot_4wkNR_cellchat_obj.rds"))
```
```{r}
