...
# GET DATA
```{r data}
DATA_DIR <- "/w5home/bmoore/scRNAseq_downstream/data/input_data/gamm_data/"
setwd(DATA_DIR)
...
# merge
```{r merge}
seurat.combined <- merge(seurat.obj.1,
    y = seurat.obj.2,
...
# write
```{r write}
output <- "/w5home/bmoore/scRNAseq/GAMM/"
# write as seurat obj
saveRDS(seurat.combined, file = paste0(output, "GAMM_S1-S2_combined.rds"))
# write as h5ad obj
# first save seurat as h5 seurat file
SaveH5Seurat(seurat.combined, filename = paste0(output, "GAMM_S1-S2_combined.h5Seurat"))
# then convert to h5ad
Convert(paste0(output, "GAMM_S1-S2_combined.h5Seurat"), dest = paste0(output, "GAMM_S1-S2_combined.h5ad"))
```
